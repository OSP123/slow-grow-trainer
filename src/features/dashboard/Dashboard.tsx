    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <div className="card" style={{ marginBottom: '2rem', padding: '0', overflow: 'hidden', border: '1px solid #1a2e1a' }}>
        <div style={{ backgroundColor: '#0a140a', padding: '0.75rem 1.5rem', borderBottom: '1px solid #1a2e1a', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          <span style={{ color: isNonImperial ? '#ef4444' : '#4ade80', fontSize: '1.2rem', fontFamily: isNonImperial ? 'var(--font-head)' : 'monospace' }}>_</span>
          <h2 style={{ fontSize: '1rem', margin: 0, color: isNonImperial ? '#ef4444' : '#4ade80', fontFamily: isNonImperial ? 'var(--font-head)' : 'monospace', textTransform: 'uppercase', letterSpacing: '1px' }}>
        ...
        <div style={{ 
          ...
          fontFamily: isNonImperial ? 'var(--font-head)' : '"Courier New", Courier, monospace', 
          lineHeight: 1.6, 
          fontSize: '0.95rem',
